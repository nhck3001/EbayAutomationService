...
namespace EbayAutomationService.Models
{
    ...
    public class CjProduct
    {
        ...
        [JsonProperty("directMinOrderNum")]
        public string DirectMinOrderNum { get; set; }
        [JsonProperty("zoneRecommendJson")]
        public string ZoneRecommendJson { get; set; }  

        [JsonProperty("setRecommendedTime")]
        public string SetRecommendedTime { get; set; }  
        public string SyncListedProductStatus { get; set; }  
        [JsonProperty("inventoryInfo")]
        public string InventoryInfo { get; set; }  
        [JsonProperty("variantKeyEn")]
        public string VariantKeyEn { get; set; }  
        
        [JsonProperty("variantInventories")]
